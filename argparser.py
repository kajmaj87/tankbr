...
p.add('--game_survived_score', type=float, help="max additional score you can get if you survive till the end of the match. Score given is proportional to time lived.")
